...
return new class extends Migration
{
    ...
    {
        Schema::create('t_revistacientificalog', function (Blueprint $table) {
            $table->integer('id_revistacientificalog');
            $table->integer('id_revistacientifica')->default('0');
            ...
            $table->primary(['id_revistacientificalog', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_revistacientificalog');
    }
};
