...
return new class extends Migration
{
    ...
    {
        Schema::create('t_fechapago', function (Blueprint $table) {
            $table->integer('id_fechapago');
            ...
            $table->primary(['id_fechapago', 'id_plan', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_fechapago');
    }
};
