...
return new class extends Migration
{
    ...
    {
        Schema::create('t_tipopostgrado', function (Blueprint $table) {
            $table->integer('id_tipopost');
            ...
            $table->primary(['id_tipopost', 'id_plan', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_tipopostgrado');
    }
};
