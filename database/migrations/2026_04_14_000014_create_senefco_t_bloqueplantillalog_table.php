...
return new class extends Migration
{
    ...
    {
        Schema::create('t_bloqueplantillalog', function (Blueprint $table) {
            $table->integer('id_bloqueplantillalog');
            $table->integer('id_bloqueplantilla')->default('0');
            ...
            $table->primary(['id_bloqueplantillalog', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_bloqueplantillalog');
    }
};
