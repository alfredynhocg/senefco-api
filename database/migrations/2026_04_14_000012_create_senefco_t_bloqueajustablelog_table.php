...
return new class extends Migration
{
    ...
    {
        Schema::create('t_bloqueajustablelog', function (Blueprint $table) {
            $table->integer('id_bloqueajustablelog');
            ...
            $table->string('bd_campos', 200)->nullable();
            $table->string('bd_condicion', 200)->nullable();
            $table->string('bd_campos_alias', 200)->nullable();
            ...
            $table->primary(['id_bloqueajustablelog', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_bloqueajustablelog');
    }
};
