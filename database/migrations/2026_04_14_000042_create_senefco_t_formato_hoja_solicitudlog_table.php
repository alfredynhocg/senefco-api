...
return new class extends Migration
{
    ...
    {
        Schema::create('t_formato_hoja_solicitudlog', function (Blueprint $table) {
            $table->integer('id_formato_hoja_solicitudlog');
            $table->integer('id_formato_hoja_solicitud')->default('0');
            ...
            $table->primary(['id_formato_hoja_solicitudlog', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_formato_hoja_solicitudlog');
    }
};
