...
return new class extends Migration
{
    ...
    {
        Schema::create('t_revistalog', function (Blueprint $table) {
            $table->integer('id_revistalog');
            $table->integer('id_revista')->default('0');
            ...
            $table->primary(['id_revistalog', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_revistalog');
    }
};
