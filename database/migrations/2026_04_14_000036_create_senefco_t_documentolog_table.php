...
return new class extends Migration
{
    ...
    {
        Schema::create('t_documentolog', function (Blueprint $table) {
            $table->integer('id_documentolog');
            $table->integer('id_documento')->default('0');
            ...
            $table->primary(['id_documentolog', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_documentolog');
    }
};
