...
return new class extends Migration
{
    ...
    {
        Schema::create('t_hojaevaluacionlog', function (Blueprint $table) {
            $table->integer('id_hojaevaluacionlog');
            $table->integer('id_hojaevaluacion')->default('0');
            ...
            $table->primary(['id_hojaevaluacionlog', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_hojaevaluacionlog');
    }
};
