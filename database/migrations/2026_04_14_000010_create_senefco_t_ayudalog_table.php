...
return new class extends Migration
{
    ...
    {
        Schema::create('t_ayudalog', function (Blueprint $table) {
            $table->integer('id_ayudalog');
            $table->integer('id_ayuda')->default('0');
            ...
            $table->primary(['id_ayudalog', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_ayudalog');
    }
};
