...
return new class extends Migration
{
    ...
    {
        Schema::create('t_cartamodelolog', function (Blueprint $table) {
            $table->integer('id_cartamodlog');
            $table->integer('id_cartamod')->default('0');
            ...
            $table->primary(['id_cartamodlog', 'id_us_reg']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('t_cartamodelolog');
    }
};
